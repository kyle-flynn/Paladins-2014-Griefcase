...
public class RobotMap {
    //Modes
    public static final boolean IS_REAL_BOT          = true;
    public static final boolean DOES_USE_AUTO_RELOAD = false;
    ...
    //DIP Switches
    public static final int AUTONOMOUS_1 = 1;
    public static final int AUTONOMOUS_2 = 2;
    public static final int AUTONOMOUS_3 = 3;
    public static final int AUTONOMOUS_4 = 4;    
    
    // LaunchPad stuff
    public static final int STICK_ONE = 1;
    public static final int LAUNCHPAD_A = 2;
    public static final int LAUNCHPAD_B = 3;
