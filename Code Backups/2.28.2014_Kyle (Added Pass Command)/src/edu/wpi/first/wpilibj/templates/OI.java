...
public class OI {
    ...
    public Button reloadMe          = new JoystickButton(launchpadA, 1);
    public Button shootMe           = new JoystickButton(launchpadA, 2);
    public Button toggleTable       = new JoystickButton(launchpadA, 3);
