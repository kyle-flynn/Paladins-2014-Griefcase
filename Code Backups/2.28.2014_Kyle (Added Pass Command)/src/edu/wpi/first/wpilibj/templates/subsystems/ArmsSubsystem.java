...
public class ArmsSubsystem extends Subsystem {
    ...
    public void rightPickUp(float speed) {
        if (RobotMap.IS_REAL_BOT == true) {
            rightArmTalon.set(speed + 0.075);
        }
        else {
           rightArmJaguar.set(speed + 0.075); 
        }
    }
    ...
    public void leftPickUp(float speed) {
        if (RobotMap.IS_REAL_BOT == true) {
            leftArmTalon.set(REVERSE * speed);
        }
        else {
           leftArmJaguar.set(REVERSE * speed); 
        }
    }
    ...
    public void rightReleaseBall(float speed) {
        if (RobotMap.IS_REAL_BOT == true) {
            rightArmTalon.set(REVERSE * (speed + 0.175));
        }
        else {
           rightArmJaguar.set(REVERSE * (speed + 0.175)); 
        }
    }
    ...
    public void leftReleaseBall(float speed) {
        if (RobotMap.IS_REAL_BOT == true) {
            leftArmTalon.set(speed);
        }
        else {
           leftArmJaguar.set(speed); 
        }
    }
