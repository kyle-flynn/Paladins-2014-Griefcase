...
public class ArmsSubsystem extends Subsystem {
    ...
    public void rightPickUp() {
        if (RobotMap.IS_REAL_BOT == true) {
            rightArmTalon.set(ARM_MOTOR_SPEED);
        }
        else {
           rightArmJaguar.set(REVERSE * ARM_MOTOR_SPEED); 
        }
    }
    ...
    public void rightReleaseBall() {
        if (RobotMap.IS_REAL_BOT == true) {
            rightArmTalon.set(REVERSE * ARM_MOTOR_SPEED);
        }
        else {
           rightArmJaguar.set(ARM_MOTOR_SPEED); 
        }
    }
